...
public class ChatBot {
    ...
    private void handleCommand(String chatId, String command) {
        if (command.equalsIgnoreCase("/list")) {
            ...
            showHelp(chatId); // New command handler
    ...
    private void showHelp(String chatId) {
        String helpMessage = "Available Commands:\n" +
                "/list - List available observer types.\n" +
                "/observed - List all current observers.\n" +
                "/add <observerType> <name> - Add a new observer.\n" +
                "/status <observerId> <newStatus> - Update the status of an observer.\n" +
                "/remove <observerId> - Remove an observer by ID.\n" +
                "/help - Show this help message.";
        bot.execute(new SendMessage(chatId, helpMessage));
    }
